...
# Parsing Script – UC502 - Rev. A

This **Parsing** script is designed for the **UC502** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – UC502 Rev. A

Este script de **Parsing** está diseñado para el modelo **UC502** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
